...
def fnv():
    ...
    collector(validate_mappings.partial().expand_kwargs(grouped), task_id="collect_validate_mappings")
    collector(identify_missing_write_aliases.expand(input_data=a), task_id="collect_identify_missing_write_aliases")
